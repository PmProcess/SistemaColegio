                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            ></textarea>
                                            <div
                                                v-if="errores.description.error"
                                                class="
                                                    fv-plugins-message-container
                                                    invalid-feedback
                                                "
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            >
                                                ...
                                                <i
                                                    ...
                                                    "
                                                    data-bs-toggle="tooltip"
                                                    title="Acceso total a los permisos"
                                                ></i>
                                            </label>
                                        </div>
                                        <div class="col-md-12">
...
<script>
export default {
    props: ["permisos", "old", "errores_laravel", "csrf", "error","rol"],
    ...
    created() {
        this.modelo=this.rol;
        this.ruta = route("rol.update",this.modelo.id);
    },
    mounted() {
        let $this = this;
