...
export default {
    ...
    mounted() {
        ...
        $(document).on("click", ".btn-edit", function () {
            ...
            window.location.href=route('alumno.edit',row.id)
        });
        $(document).on("click", ".btn-delete", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    await axios
                        .post(route("alumno.destroy", row.id))
                        .then((value) => {
                            // $this.table
                            //     .row($(this).closest("tr"))
                            //     .remove()
    ...
    methods: {
        dataTableInicializacion: function () {
            this.table = $("#tableAlumnos").DataTable({
                bPaginate: true,
                bLengthChange: true,
                bFilter: true,
                bInfo: true,
                ...
                columns: [
                    ...
                    },
                    {
                        data: null,
                        render: function (data) {
                            return data.persona.tipo_persona.nombres+" "+data.persona.tipo_persona.apellidos
                        },
                    },
                    {
                        data: null,
                        className:"text-center",
                        render: function (data) {
                            return data.persona.tipo_persona.dni
                        },
                    },
                    {
                        data: null,
        ...
        createAlumno:function(){
            window.location.href=route('alumno.create')
        }
    },
